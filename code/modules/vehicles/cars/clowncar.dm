/obj/vehicle/sealed/car/clowncar
	...
	icon_state = "clowncar"
	max_integrity = 175 // Cit change added 25hp 
	armor = list("melee" = 40, "bullet" = 30, "laser" = 20, "energy" = 0, "bomb" = 30, "bio" = 0, "rad" = 1, "fire" = 80, "acid" = 80) //Cit change Removed Lots of armor and made it rad
	enter_delay = 20
	max_occupants = 50
	movedelay = 0.6
